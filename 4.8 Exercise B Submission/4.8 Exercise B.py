...
########################
def newFilter():
  change = input("What colored shine do you want to filter the image through?: Pink, Green, or Yellow?")
  ...
  while location < len(new_pixels):
    ...
    if change == "Pink":
      ...
      print("You chose none of the options, therefore the image will not be changed")
      Rvalue = 1
      Bvalue = 1
      Gvalue = 1
